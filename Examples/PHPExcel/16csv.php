...
$IO = \Library\Excel::IOFactory();

$objWriter = $IO::createWriter($objPHPExcel, 'CSV')->setDelimiter(',')
                                                                  ->setEnclosure('"')
                                                                  ->setSheetIndex(0)
...
$callStartTime = microtime(true);
$objReader = $IO::createReader('CSV')->setDelimiter(',')
                                                    ->setEnclosure('"')
                                                    ->setSheetIndex(0);
...
$objWriter2007 = $IO::createWriter($objPHPExcelFromCSV, 'Excel2007');
...
$objWriterCSV = $IO::createWriter($objPHPExcelFromCSV, 'CSV');
